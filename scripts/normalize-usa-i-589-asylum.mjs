// Normaliza el PDF I-589 oficial USCIS — descomprime object streams y
// re-serializa con xref tradicional para que pdf-lib 1.17 pueda leer/rellenar
// el AcroForm.
//
// Uso: node scripts/normalize-usa-i-589-asylum.mjs
// Input : public/forms/usa-i-589-asylum.pdf  (encrypted/compressed)
// Output: public/forms/usa-i-589-asylum.pdf  (normalized in place + backup)
...
const BACKUP_PATH = path.join(repoRoot, 'public', 'forms', 'usa-i-589-asylum.original.pdf')
