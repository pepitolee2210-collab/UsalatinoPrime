// Normaliza el PDF USCIS I-130 — descomprime object streams y re-serializa con
...
// PDF 1.5+) que pdf-lib 1.17 no descomprime correctamente (devuelve 0 fields
// + "Invalid object ref"). mupdf-js (Artifex MuPDF wrapped en WASM) sí los
// maneja y al re-guardar produce un PDF equivalente con xref tradicional.
//
// Uso: node scripts/normalize-i130.mjs
// Input : public/forms/i-130.pdf  (compressed)
// Output: public/forms/i-130.pdf  (normalized in place — backup .original.pdf)
...
const BACKUP_PATH = path.join(repoRoot, 'public', 'forms', 'i-130.original.pdf')
